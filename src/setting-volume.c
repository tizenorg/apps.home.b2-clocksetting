...
static void _set_volumn(sound_type_e type, int volume_index, char* vconf_key)
{
	...
	if( (type == SOUND_TYPE_RINGTONE) || (type == SOUND_TYPE_NOTIFICATION) )
	{
	...
	{
		vconf_set_int(vconf_key, volume_index);
